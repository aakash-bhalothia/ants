    ...
    def add_insect(self, insect):
        ...
        if insect.is_ant:
            if self.ant is None:
                ...
                elif self.ant.container == False and insect.container == True and insect.ant is None:
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        """
        # BEGIN Problem 3B
        placeofbees = self.place

        for i in range(self.min_range):
            placeofbees = placeofbees.entrance
        i = 0
        while placeofbees.entrance != None and placeofbees.entrance != hive and len(placeofbees.bees) == 0 and i < self.max_range:
            placeofbees = placeofbees.entrance
            i += 1
        return random_or_none(placeofbees.bees)
...
class NinjaAnt(Ant):
    ...
    def action(self, colony):
        # BEGIN Problem 6A
        listofbees = colony.bees
        for bee in listofbees:
            ...
            while throw_place:
                if throw_place.ant:
                    if throw_place.ant.container == True:
                        QueenAnt.doubled_ants.append(throw_place.ant)
                        if throw_place.ant.ant:
                            
                            QueenAnt.doubled_ants.append(throw_place.ant.ant)
                    else:
                        QueenAnt.doubled_ants.append(throw_place.ant)
                throw_place = throw_place.exit


        for ant in QueenAnt.doubled_ants:
            if ant.buffed == False:
                ant.damage *= 2
            ant.buffed = True
